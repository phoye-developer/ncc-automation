...
# Functions
acd_voicemail_function_body = {
    "localizations": {
        "name": {"en": {"language": "en", "value": "Test ACD Voicemail"}}
    },
    "name": "Test ACD Voicemail",
    "states": {
        ...
        "start-state": {
            ...
            "transitions": [
                {"name": "Transition - Record VM", "id": "5dc4023452d09c4fc8369c19"}
            ],
            "objectType": "campaignstate",
            "key": "start-state",
            "_id": "start-state",
        ...
        "5dc401fe07b302d7a780e761": {
            ...
            "__gohashid": 4074,
            "transitions": [
                {"name": "Transition - Options Menu", "id": "refId1573126598874"}
            ],
        },
        "5dc40291e680339a6aecc831": {
            ...
            "__gohashid": 8936,
            "transitions": [
                {"name": "Transition - Options Menu", "id": "refId1573126598778"},
                {"name": "Transition - Record VM", "id": "refId1573126598787"},
                {"name": "Transition - Create VM", "id": "refId1573126598797"},
                {"name": "Transition - Options Menu", "id": "refId1585421559053"},
            ],
        },
...
acd_callback_function_body = {
    "localizations": {"name": {"en": {"language": "en", "value": "Test ACD Callback"}}},
    "name": "Test ACD Callback",
    "states": {
                ...
                },
                {
                    ...
                    "properties": {
                        ...
                        "points": {
                            ...
                            "_isFrozen": True,
                            "s": [
                                {"x": 389, "y": 339.55067825317377, "_isFrozen": True},
                                {"x": 399, "y": 339.55067825317377, "_isFrozen": True},
                                {"x": 396, "y": 339.55067825317377, "_isFrozen": True},
                                {"x": 396, "y": 339.55067825317377, "_isFrozen": True},
                                {"x": 526, "y": 339.55067825317377, "_isFrozen": True},
                                {"x": 526, "y": 360.80209443918415, "_isFrozen": True},
                                {"x": 526, "y": 370.80209443918415, "_isFrozen": True},
                            ],
                            "Ja": 7,
                        },
                    },
                ...
                },
                {
                    ...
                    "properties": {
                        ...
                        "points": {
                            ...
                            "_isFrozen": True,
                            "s": [
                                {"x": 609, "y": 471.70213868967244, "_isFrozen": True},
                                {"x": 619, "y": 471.70213868967244, "_isFrozen": True},
                                {"x": 620, "y": 471.70213868967244, "_isFrozen": True},
                                {"x": 620, "y": 471.70213868967244, "_isFrozen": True},
                                {
                                    "x": 751.0000000000002,
                ...
                },
                {
                    ...
                    "properties": {
                        ...
                        "points": {
                            ...
                            "_isFrozen": True,
                            "s": [
                                {"x": 609, "y": 515.7021386896724, "_isFrozen": True},
                                {"x": 619, "y": 515.7021386896724, "_isFrozen": True},
                                {"x": 619, "y": 515.7021386896724, "_isFrozen": True},
                                {"x": 619, "y": 630.8506408691406, "_isFrozen": True},
                                {"x": 519, "y": 630.8506408691406, "_isFrozen": True},
                                {"x": 519, "y": 640.8506408691406, "_isFrozen": True},
                            ],
                            "Ja": 6,
                        },
                    },
                ...
                },
                {
                    ...
                    "properties": {
                        ...
                        "points": {
                            ...
                            "_isFrozen": True,
                            "s": [
                                {"x": 609, "y": 559.7021386896724, "_isFrozen": True},
                                {"x": 619, "y": 559.7021386896724, "_isFrozen": True},
                                {
                                    "x": 642.261423749154,
                                    "y": 559.7021386896724,
                                    "_isFrozen": True,
