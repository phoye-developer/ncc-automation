...
def freshdesk_create_user_survey(
    ncc_location: str,
    ncc_token: str,
    survey_name: str,
    survey_categories: list,
                                        ...
                                        "elements": [
                                            {
                                                ...
                                                "properties": {
                                                    ...
                                                    "width": "100%",
                                                    "fieldname": "name",
                                                    "defaultValue": '${workitem.data.contactInfo?.name || ""}',
                                                    "mandatory": False,
                                                    "readOnly": False,
                                                    "validateOnInput": False,
                                                    "sensitiveData": False,
                                ...
                                "elements": [
                                    {
                                        ...
                                        "properties": {
                                            ...
                                            "buttonWidth": "200px",
                                            "buttonPadding": "10px",
                                            "condition": '${workitem.data.contactInfo} != ""',
                                            "type": "newTab",
                                            "url": "https://"
                                            + freshdesk_subdomain
                                            + ".freshdesk.com/a/contacts/${workitem.data.contactInfo.id}",
                                            "onEvent": "onButtonClick",
                                            "useProxy": False,
                                            "windowName": "Freshdesk",
                                            "properties": [],
                                            "headers": [],
                                            "successVariables": [],
                                            "onSuccess": "none",
